...
public interface IRepo<TId, TModel> where TModel : class
{
    ...
    Task<Page<TModel>> SelectPageAsync(SelectParams<TModel>? selectParams = null, PageParams? @params = null, CancellationToken ct = default);
